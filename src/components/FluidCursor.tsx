...
export function FluidCursor({
  ...
  useEffect(() => {
    ...
    // Config setup matching Inspira UI fluid-cursor
    const config = {
    ...
    function clickSplat(pointer: Pointer) {
      const color = generatePurpleColor();
      color.r *= 5;
      color.g *= 2;
      color.b *= 5;
    ...
    function updatePointerDownData(pointer: Pointer, id: number, posX: number, posY: number) {
      ...
      pointer.deltaX = 0;
      pointer.deltaY = 0;
      pointer.color = generatePurpleColor();
    }
